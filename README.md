...
Приложение доступно по адресу: **[mamacare.ru](https://mamacare.ru)**

Для начала работы достаточно создать аккаунт — имя, email и пароль. Данные хранятся только на сервере, не передаются третьим сторонам.
...
По вопросам лицензирования: razmorinyt@gmail.com
